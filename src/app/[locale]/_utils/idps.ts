...
const IDPS: { identityProviders: IdentityProvider[]; richiediSpid: string } = {
  identityProviders: [
    ...
    },
    {
      ...
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-intesigroupspid.png',
    },
    {
      identifier: 'Register',
      entityId: 'spiditalia',
      name: 'SpidItalia',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-spiditalia.png',
    },
    {
      identifier: 'Sielte',
      entityId: 'sielteid',
      name: 'Sielte id',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-sielteid.png',
    },
    {
      identifier: 'Namirial',
      entityId: 'namirialid',
      name: 'Namirial ID',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-namirialid.png',
    },
    {
      identifier: 'Tim',
      entityId: 'timid',
      name: 'TIM id',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-timid.png',
    },
    {
      identifier: 'Lepida',
      entityId: 'lepidaid',
      name: 'Lepida',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-lepidaid.png',
    },
    {
      identifier: 'TeamSystem',
      entityId: 'teamsystemid',
      name: 'TeamSystem',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-teamsystemid.png',
    },
    {
      identifier: 'EtnaHitech',
      entityId: 'ehtid',
      name: 'Etna Hitech S.C.p.A.',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-etnaid.png',
    },
    {
      identifier: 'InfoCamere',
      entityId: 'infocamereid',
      name: 'InfoCamere S.C.p.A.',
      imageUrl: 'https://assets.io.pagopa.it/spid/idps/spid-idp-infocamereid.png',
    },
