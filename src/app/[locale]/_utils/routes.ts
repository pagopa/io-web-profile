...
export const EMAIL_VALIDATION_ROUTES = [ROUTES.EMAIL_CONFIRMATION,ROUTES.EMAIL_CONFIRMED,ROUTES.EMAIL_NOT_CONFIRMED,ROUTES.EMAIL_CONFIRMATION_LINK_EXPIRED];
